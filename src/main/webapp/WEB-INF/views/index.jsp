		...
		<h1>
			독서실 관리 프로그램  <c:choose>
					<c:when test="${sessionScope.sid==null }">
						<strong><a href="login/login"><input type="button" name="button" value="로그인"></a>
						<a href="join/join"><input type="button" name="button" value="회원가입"></a></strong>
					</c:when>
					<c:otherwise>
						<strong>${sid }님환영합니다.<input name="button" type="button" onClick-"location.href='index.html' " value="로그아웃"></strong>
